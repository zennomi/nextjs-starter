...
export const TanStackIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 633 633" width="1em" height="1em">
    <defs>
      <linearGradient id="tanstack_svg__b" x1="50%" x2="50%" y1="0%" y2="71.65%">
      ...
      <linearGradient id="tanstack_svg__d" x1="43.996%" x2="53.441%" y1="8.54%" y2="93.872%">
      ...
      <linearGradient id="tanstack_svg__k" x1="92.9%" x2="8.641%" y1="45.768%" y2="54.892%">
        <stop offset="0%" stopColor="#EE2700" />
        <stop offset="100%" stopColor="#FF008E" />
      </linearGradient>
      <linearGradient id="tanstack_svg__l" x1="61.109%" x2="43.717%" y1="3.633%" y2="43.072%">
      ...
      <linearGradient id="tanstack_svg__n" x1="127.279%" x2="0%" y1="49.778%" y2="50.222%">
        <stop offset="0%" stopColor="#FFA400" />
        <stop offset="100%" stopColor="#FF5E00" />
      </linearGradient>
      <linearGradient id="tanstack_svg__o" x1="127.279%" x2="0%" y1="47.531%" y2="52.469%">
        <stop offset="0%" stopColor="#FFA400" />
        <stop offset="100%" stopColor="#FF5E00" />
      </linearGradient>
      <linearGradient id="tanstack_svg__p" x1="127.279%" x2="0%" y1="46.195%" y2="53.805%">
        <stop offset="0%" stopColor="#FFA400" />
        <stop offset="100%" stopColor="#FF5E00" />
      </linearGradient>
      <linearGradient id="tanstack_svg__q" x1="127.279%" x2="0%" y1="35.33%" y2="64.67%">
        <stop offset="0%" stopColor="#FFA400" />
        <stop offset="100%" stopColor="#FF5E00" />
      </linearGradient>
      <linearGradient id="tanstack_svg__r" x1="127.279%" x2="0%" y1="4.875%" y2="95.125%">
        <stop offset="0%" stopColor="#FFA400" />
        <stop offset="100%" stopColor="#FF5E00" />
      </linearGradient>
      <linearGradient id="tanstack_svg__s" x1="78.334%" x2="31.668%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFA400" />
        <stop offset="100%" stopColor="#FF5E00" />
      </linearGradient>
      <linearGradient id="tanstack_svg__t" x1="57.913%" x2="44.88%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFA400" />
        <stop offset="100%" stopColor="#FF5E00" />
      </linearGradient>
      <linearGradient id="tanstack_svg__u" x1="50.495%" x2="49.68%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFA400" />
        <stop offset="100%" stopColor="#FF5E00" />
      </linearGradient>
    ...
    <g fill="none" fillRule="evenodd" transform="translate(9 8)">
      ...
      <g mask="url(#tanstack_svg__c)">
        <g transform="translate(389 -32)">
          <circle cx={168.5} cy={113.5} r={113.5} fill="url(#tanstack_svg__m)" />
          <circle
            cx={168.5}
            cy={113.5}
            r={106}
